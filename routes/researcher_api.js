    ...
    flow.exec(
        function () {
            ...
            if (request.body.keyword1_TH != "") {
                ...
                researcher.keywordString = researcher.keywordString + (Validate.scrappingCleanUp(request.body.keyword1_TH) + " / " + Validate.scrappingCleanUp(request.body.keyword1_EN)) + " , "
            }
            if (request.body.keyword2_TH != "") {
                ...
                researcher.keywordString = researcher.keywordString + (Validate.scrappingCleanUp(request.body.keyword2_TH) + " / " + Validate.scrappingCleanUp(request.body.keyword2_EN)) + " , "
            }
            if (request.body.keyword3_TH != "") {
                ...
                researcher.keywordString = researcher.keywordString + (Validate.scrappingCleanUp(request.body.keyword3_TH) + " / " + Validate.scrappingCleanUp(request.body.keyword3_EN)) + " , "
            }
            if (request.body.keyword4_TH != "") {
                ...
                researcher.keywordString = researcher.keywordString + (Validate.scrappingCleanUp(request.body.keyword4_TH) + " / " + Validate.scrappingCleanUp(request.body.keyword4_EN)) + " , "
            }
            if (request.body.keyword5_TH != "") {
                ...
                researcher.keywordString = researcher.keywordString + (Validate.scrappingCleanUp(request.body.keyword5_TH) + " / " + Validate.scrappingCleanUp(request.body.keyword5_EN)) + " , "
            }
